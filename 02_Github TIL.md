...
- `git bash` 에서 `TIL` 폴더로 이동한 이후에 아래의 명령어호 `git` 관리를 시작한다
...
> Repository 에 접속하여 사용하기 위해서는 사전에 사용자 등록을 해줘야 합니다.
...
2. repository
3. settings(상단오른쪽 메뉴)
4. collaborators (Search by username, full name or email address)
5. User 등록